...
export const guides: Guide[] = [
  ...
  },
  {
    ...
    title: "Cămine de canalizare din prefabricate de beton: bază, inele, con, capac",
    seoTitle: "Cămine de canalizare din beton: bază, inele, con și capac",
    description: "Din ce elemente prefabricate se compune un cămin de canalizare, ce variante există, cum se montează și ce trebuie să conțină comanda. Producție proprie în Satu Mare.",
    published: "2026-09-05",
    updated: "2026-09-05",
    readingMinutes: 5,
    keywords: ["cămine vizitare beton", "bază cămin canalizare", "inele cămin beton", "prefabricate canalizare Satu Mare"],
    intro: "Căminele de vizitare ale unei rețele de canalizare se asamblează din patru tipuri de elemente prefabricate din beton. Ghidul de mai jos explică rolul fiecăruia, variantele pe care le producem și ce informații ne trebuie pentru o ofertă exactă.",
    sections: [
      {
        heading: "Baza de cămin",
        paragraphs: ["Baza este elementul de fund al căminului și se alege după conductele care intră în el: diametrul ieșirilor (Ø200, Ø250 sau Ø315), configurația (linie, capăt de rețea, ramificație în Y sau cot la 90°) și tipul radierului (fund plat sau cu șanț de curgere). Pentru cămine de vane sau de rupere de pantă se folosește baza fără ieșiri."],
      },
      {
        heading: "Inelele de cămin",
        paragraphs: ["Corpul căminului se ridică din inele cu înălțimi de 0,50, 0,60, 0,75 și 1,00 m, combinate astfel încât să ajungă cât mai aproape de cota terenului. Inelul de 10 cm servește la reglajul fin al înălțimii sub capac. Îmbinările se etanșează cu mortar sau garnituri, conform proiectului."],
      },
      {
        heading: "Conul de reducție și capacul",
        paragraphs: ["Conul reduce secțiunea căminului către gura de acces, iar capacul din beton armat de 1 m închide căminul și preia rama cu capacul din fontă. În zonele carosabile se montează capace și rame cu clasa de încărcare cerută de trafic (de regulă D400)."],
      },
      {
        heading: "Montaj",
        paragraphs: ["Elementele se așază pe un pat de beton de egalizare, cu macaraua camionului de livrare, direct în șanț. Conductele se racordează în ieșirile turnate din fabrică, iar spațiul din jur se umple cu balast compactat în straturi. Căminele se amplasează la schimbări de direcție, de pantă și la maximum 60 m unul de altul."],
      },
      {
        heading: "Ce ne trebuie pentru ofertă",
        paragraphs: [`Lista de cămine cu diametrele ieșirilor, configurația bazelor, înălțimile inelelor și cantitățile, localitatea și accesul pentru camionul cu macara. Sunați la ${contact.phoneDisplay} sau scrieți la ${contact.email}; confirmăm stocul și termenul de livrare în aceeași zi.`],
      },
    ],
    related: [
      { label: "Prefabricate: categorii de produse", href: "/prefabricate/" },
