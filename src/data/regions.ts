...
export const regions: Region[] = [
  {
    ...
    cities: [
      ...
      { name: "Livada", km: 9, minutes: 10 },
      { name: "Halmeu", km: 9, minutes: 16 },
      { name: "Satu Mare", km: 24, minutes: 30 },
      { name: "Negrești-Oaș", km: 35, minutes: 40 },
      { name: "Ardud", km: 47, minutes: 45 },
      { name: "Carei", km: 59, minutes: 63 },
      { name: "Tășnad", km: 79, minutes: 81 },
    ],
  ...
  },
  {
    ...
    cities: [
      { name: "Seini", km: 28, minutes: 28 },
      { name: "Baia Mare", km: 54, minutes: 65 },
      { name: "Baia Sprie", km: 63, minutes: 79 },
      { name: "Sighetu Marmației", km: 90, minutes: 118 },
      { name: "Târgu Lăpuș", km: 98, minutes: 111 },
      { name: "Vișeu de Sus", km: 159, minutes: 197 },
    ],
  ...
  },
  {
    ...
    cities: [
      { name: "Valea lui Mihai", km: 94, minutes: 94 },
      { name: "Marghita", km: 105, minutes: 109 },
      { name: "Săcueni", km: 118, minutes: 117 },
      { name: "Oradea", km: 161, minutes: 162 },
      { name: "Salonta", km: 204, minutes: 200 },
      { name: "Beiuș", km: 217, minutes: 227 },
    ],
  ...
  },
  {
    ...
    cities: [
      { name: "Cehu Silvaniei", km: 78, minutes: 88 },
      { name: "Jibou", km: 92, minutes: 106 },
      { name: "Șimleu Silvaniei", km: 104, minutes: 106 },
      { name: "Zalău", km: 109, minutes: 122 },
    ],
