...
export const regions: Region[] = [
  {
    ...
    cities: [
      ...
      { name: "Halmeu", km: 8, minutes: 10 },
      { name: "Negrești-Oaș", km: 30, minutes: 30 },
      { name: "Satu Mare", km: 28, minutes: 30 },
      { name: "Ardud", km: 45, minutes: 45 },
      { name: "Carei", km: 60, minutes: 60 },
      { name: "Tășnad", km: 80, minutes: 80 },
    ],
  ...
  },
  {
    ...
    intro:
      "Maramureșul este al doilea județ ca volum de livrări. Seini este la mai puțin de jumătate de oră, iar Baia Mare și Baia Sprie la sub o oră de unitățile noastre, ceea ce ne permite să livrăm beton în condiții de rețetă și agregate în cantități de șantier, cu programare de la o zi la alta.",
    cities: [
      { name: "Seini", km: 26, minutes: 23 },
      { name: "Baia Mare", km: 52, minutes: 45 },
      { name: "Baia Sprie", km: 62, minutes: 55 },
      { name: "Târgu Lăpuș", km: 100, minutes: 95 },
      { name: "Sighetu Marmației", km: 80, minutes: 90 },
      { name: "Vișeu de Sus", km: 140, minutes: 160 },
    ],
  ...
  },
  {
    ...
    cities: [
      { name: "Valea lui Mihai", km: 85, minutes: 85 },
      { name: "Săcueni", km: 100, minutes: 100 },
      { name: "Marghita", km: 100, minutes: 95 },
      { name: "Oradea", km: 150, minutes: 130 },
      { name: "Salonta", km: 185, minutes: 160 },
      { name: "Beiuș", km: 210, minutes: 190 },
    ],
  ...
  },
  {
    ...
    intro:
      "În Sălaj deservim lucrări de infrastructură și construcții din Zalău, Șimleu Silvaniei, Jibou și Cehu Silvaniei. Distanțele de 85–125 km fac agregatele și prefabricatele produsele cele mai solicitate; betonul se livrează pentru lucrări programate, cu rețete adaptate.",
    cities: [
      { name: "Cehu Silvaniei", km: 85, minutes: 85 },
      { name: "Șimleu Silvaniei", km: 115, minutes: 115 },
      { name: "Jibou", km: 115, minutes: 120 },
      { name: "Zalău", km: 125, minutes: 125 },
    ],
