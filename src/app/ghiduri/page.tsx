...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Ghiduri utile: beton, agregate, prefabricate", description: "Răspunsuri practice la întrebările clienților din Satu Mare și Nord-Vest.", url: "/ghiduri/", type: "website", images: [{ url: ogImage, width: 1200, height: 630 }] },
};
